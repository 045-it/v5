  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className='p-6 space-y-6'>
        ...
        <input type="text" name="txt_password" defaultValue={form.txt_password} onChange={handleChange} className='w-full border text-black border-black rounded-md px-4 py-2' placeholder='password' />


        <button type="submit" className="px-5 py-2 bg-blue-600 text-black rounded-md hover:bg-blue-700">บันทึกข้อมูล</button>
      </form>
    </div>
    </div>
  )
